...
%% figure handle
close; figure(1); set(gcf, 'Units', 'centimeters', 'Position', [0 0 21.5 25], 'PaperUnits', 'centimeters', 'PaperSize', [21.5 25]);
...
%         boxplot(pars,'Positions',[2:8],'Colors',cmap(2:end,:),'PlotStyle', 'compact','OutlierSize',1)      
    ...
    save('poly_order_vol','poly_order_vol')
    save('total_Vol_shrink','total_Vol_shrink')
%% save figs
