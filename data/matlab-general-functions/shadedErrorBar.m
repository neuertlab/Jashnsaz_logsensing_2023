...
if transparent
    ...
    patchColor=col;
    set(gcf,'renderer','openGL'); % painters
else
    faceAlpha=1;
...
edgeLineWidth = 0.6*lineProps{2}; 
H.edge(1)=plot(x,lE,'-','color',edgeColor, 'LineWidth', edgeLineWidth);
H.edge(2)=plot(x,uE,'-','color',edgeColor, 'LineWidth', edgeLineWidth);          
